...
user = User.create!(email: 'kaneki@example.com', user_name: 'kaneki', password: 'password', gender: 0, birth_date: '1998-10-13')

user.profile_image.attach(io: File.open("#{Rails.root}/db/fixtures/sample-user1.png"),
